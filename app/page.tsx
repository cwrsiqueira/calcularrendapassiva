                  ...
                  <div className="flex flex-col gap-2 justify-center w-full">
                    ...
                    <div className="flex justify-center flex-col sm:flex-row gap-2">
                      <label className="input input-bordered flex items-center gap-2 w-full bg-white">
                        ...
                        <input className="grow" type="text" name="periodo" id="periodo" value={periodo} onChange={(e) => setPeriodo(handleMaxLength(e))} placeholder="Meses" maxLength={3} />
                      </label>

                      <label className="input input-bordered flex items-center gap-2 w-full bg-white">
                        <FontAwesomeIcon icon={faPercent} />
                        <input className="grow" type="text" name="txPeriodo" id="txPeriodo" value={txPeriodo} onChange={(e) => setTxPeriodo(maskMoney(handleMaxLength(e)))} placeholder="Taxa Mensal" maxLength={5} />
                      </label>
                    </div>
                    ...
                    <div className="flex justify-center flex-col sm:flex-row gap-2">
                      <label className="input input-bordered flex items-center gap-2 w-full bg-white">
                        ...
                        <input className="grow" type="text" name="vlrIni" id="vlrIni" value={vlrIni} onChange={(e) => setVlrIni(maskMoney(handleMaxLength(e)))} placeholder="Valor Inicial" maxLength={14} />
                      </label>

                      <label className="input input-bordered flex items-center gap-2 w-full bg-white">
                        <FontAwesomeIcon icon={faDollarSign} />
                        <input className="grow" type="text" name="vlrRecorr" id="vlrRecorr" value={vlrRecorr} onChange={(e) => setVlrRecorr(maskMoney(handleMaxLength(e)))} placeholder="Valor Recorrente" maxLength={14} />
                      </label>
                    </div>
                    ...
                    <div className="flex justify-center flex-col sm:flex-row gap-2">
                      <label className="input input-bordered flex items-center gap-2 w-full bg-white">
                        <FontAwesomeIcon icon={faDollarSign} />
                        <input className="grow" type="text" name="renda" id="renda" value={renda} onChange={(e) => setRenda(maskMoney(handleMaxLength(e)))} placeholder="Renda" maxLength={14} />
                      </label>
